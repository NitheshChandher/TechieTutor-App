...
public class Tutor_Prof extends AppCompatActivity {
    TextView x,y,z,student;
    Spinner d,e,f;
    Button submit;
    String grade,subject,location,email,name,sname,saddress,smobile,sgender;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        z.setText("Search Student Below:");
        Bundle bundle=getIntent().getExtras();
        email=bundle.getString("b1");
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                db=openOrCreateDatabase("techietutor.db",MODE_PRIVATE,null);
                c2=db.rawQuery("Select * from student where subject='"+subject+"' and location='"+location+"' and class='"+grade+"'",null);
                if(c2.getCount()==0)
                {
                    student.setText("Student Not Found");
                }
                while(c2.moveToNext())
                {
                    sname=c2.getString(0);
                    sgender=c2.getString(5);
                    smobile=c2.getString(4);


                    student.setText("Student"+sname+" "+sgender+"  "+smobile+" \n");
                }
                db.close();
                c2.close();
            }
